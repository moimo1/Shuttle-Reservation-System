...
export const scheduleReminder = async (req: any, res: any) => {
  try {
...
export const sendScheduledReminders = async (req: any, res: any) => {
  try {
    ...
    for (const notification of dueNotifications) {
      ...
      const shuttle = notification.shuttle as any;

      // Send push notification
      await sendPushNotification(
        [user.deviceToken], // Assumes user model has deviceToken field
        notification.title,
